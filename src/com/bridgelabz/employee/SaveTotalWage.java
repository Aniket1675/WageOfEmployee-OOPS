...
public class SaveTotalWage
{
    ...
    SaveTotalWage(String companyName, int wagePerHr, int maxWorkingDays, int maxWorkingHrs)
    {
    ...
    {
        SaveTotalWage google = new SaveTotalWage("Google", 8, 20, 100);
        SaveTotalWage microsoft = new SaveTotalWage("Microsoft", 4, 30, 150);
